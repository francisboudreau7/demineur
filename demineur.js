...
var largeurCase= Math.floor(largeur/images[1].length);
var hauteurCase=Math.floor(hauteur/images[1][1].length);
...
placerMines(largeur,hauteur,nbMines, souris[0], souris[1]);
